                ...
                <table border="1" class="tab">
                    ...
                    <tbody>
                        ...
                        <tr>
                          ...
                          <td><a class="bndelete" href="MachineController?op=delete&id=<%=mm.getId()%>" onclick="showConfirmation(<%=mm.getId()%>)">Supprimer</a></td>
                           
                          
                            <td><a class="bnupdate" onclick="showConfirmation2(<%=mm.getId()%>)" href="MachineController?op=update&id=<%= mm.getId()%>" >Modifier</a></td>
                        </tr>
                        <%}%>
                    </tbody>
                </table>
