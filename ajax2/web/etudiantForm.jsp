                ...
                <table border="1" class="tab">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><%=e.getSexe()%></td>
                            <td><a class="bndelete" href="EtudiantController?op=delete&id=<%=e.getId()%>" onclick="showConfirmation(<%=e.getId()%>)">Supprimer</a></td>
                           
                          
                            <td><a class="bnupdate" href="EtudiantController?op=update&id=<%=e.getId()%>" onclick="showConfirmation2(<%=e.getId()%>)" >Modifier</a></td>
                        </tr>
                        <%}%>
                    </tbody>
                </table>
